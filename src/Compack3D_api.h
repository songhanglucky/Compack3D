...
template<typename RealType, typename RealTypeComm, typename MemSpaceType>
class DistTriSolDimI {
  public:
    DistTriSolDimI() = delete;
    DistTriSolDimI(const unsigned int, const unsigned int, const unsigned int, const unsigned int, const unsigned int, MPI_Comm);
    ~DistTriSolDimI();
    void detachSharedBuffers();
    void resetSharedBuffers(RealType*, RealType*, RealType*, RealTypeComm*, RealTypeComm*, RealTypeComm*, RealTypeComm*, RealTypeComm*, RealTypeComm*, RealType*, RealType*);
    void resetSystem(RealType*, RealType*, RealType*);
    void solve(RealType*);
  ...
  protected:
    ...
    RealType* fact_local_prev;
    RealType* fact_local_curr;
    RealType* fact_local_next;
    RealType* fact_dist_prev;
    RealType* fact_dist_curr;
    RealType* fact_dist_next;
    RealType* Si;
...
template<typename RealType, typename RealTypeComm, typename MemSpaceType>
class DistTriSolDimJ {
  public:
    DistTriSolDimJ() = delete;
    DistTriSolDimJ(const unsigned int, const unsigned int, const unsigned int, const unsigned int, const unsigned int, MPI_Comm);
    ~DistTriSolDimJ();
    void detachSharedBuffers();
    void resetSharedBuffers(RealType*, RealType*, RealType*, RealTypeComm*, RealTypeComm*, RealTypeComm*, RealTypeComm*, RealTypeComm*, RealTypeComm*, RealType*, RealType*);
    void resetSystem(RealType*, RealType*, RealType*);
...
template<typename RealType, typename RealTypeComm, typename MemSpaceType>
class DistTriSolDimK {
  public:
    DistTriSolDimK() = delete;
    DistTriSolDimK(const unsigned int, const unsigned int, const unsigned int, const unsigned int, const unsigned int, MPI_Comm);
    ~DistTriSolDimK();
    void detachSharedBuffers();
    void resetSharedBuffers(RealType*, RealType*, RealType*, RealTypeComm*, RealTypeComm*, RealTypeComm*, RealTypeComm*, RealTypeComm*, RealTypeComm*, RealType*, RealType*);
    void resetSystem(RealType*, RealType*, RealType*);
