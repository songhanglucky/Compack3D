...
void DistPentaSolDimI<RealType, RealTypeComm, MemSpaceType>::solve(RealType* x) {
    ...
    penta::updateLocalSolDimI<RealType>(x_loc, this->x_tilde_cur, this->x_tilde_nbr, this->Si, this->Ri, this->NI-2, this->NJ, this->NK, this->NJ*this->NK, this->NK);
}
...
void DistPentaSolDimJ<RealType, RealTypeComm, MemSpaceType>::solve(RealType* x) {
    ...
    penta::updateLocalSolDimJ<RealType>(x_loc, this->x_tilde_cur, this->x_tilde_nbr, this->Si, this->Ri, this->NI, this->NJ-2, this->NK, this->NJ*this->NK, this->NK);
}
...
void DistPentaSolDimK<RealType, RealTypeComm, MemSpaceType>::solve(RealType* x) {
    ...
    penta::updateLocalSolDimK<RealType>(x_loc, this->x_tilde_cur, this->x_tilde_nbr, this->Si, this->Ri, this->NI, this->NJ, this->NK-2, this->NJ*this->NK, this->NK);
}
...
void DistTriSolDimI<RealType, RealTypeComm, MemSpaceType>::solve(RealType* x) {
    ...
    tri::updateLocalSolDimI<RealType>(x_loc, this->x_tilde_cur, this->x_tilde_nbr, this->Si, this->Ri, this->NI-1, this->NJ, this->NK, this->NJ*this->NK, this->NK);
}
