...
typedef cmpk::DistPentaSolDimJ<Real, RealComm, cmpk::MemSpace::Device> PentaSol;
...
int main(int argc, char* argv[]) {
   ...
   #error "Unrecognizable MPI library. Supported libraries are OpenMPI and MVAPICH2."
    ...
    // SET LINEAR SYSTEM //
    ///////////////////////
    Real* l2 = nullptr; cmpk::memAllocArray<cmpk::MemSpace::Host, Real>(&l2, NUM_GRIDS_J);
    Real* l1 = nullptr; cmpk::memAllocArray<cmpk::MemSpace::Host, Real>(&l1, NUM_GRIDS_J);
    Real* d  = nullptr; cmpk::memAllocArray<cmpk::MemSpace::Host, Real>(&d , NUM_GRIDS_J);
    Real* u1 = nullptr; cmpk::memAllocArray<cmpk::MemSpace::Host, Real>(&u1, NUM_GRIDS_J);
    Real* u2 = nullptr; cmpk::memAllocArray<cmpk::MemSpace::Host, Real>(&u2, NUM_GRIDS_J);
    ...
    cmpk::memAllocArray<cmpk::MemSpace::Device, Real    >(&shared_x_tilde_cur, 2 * NUM_GRIDS_I * NUM_GRIDS_K);
    cmpk::memAllocArray<cmpk::MemSpace::Device, Real    >(&shared_x_tilde_nbr, 2 * NUM_GRIDS_I * NUM_GRIDS_K);
    cmpk::memAllocArray<cmpk::MemSpace::Device, Real    >(&shared_x_tilde_buf, 2 * NUM_GRIDS_I * NUM_GRIDS_K);
    cmpk::memAllocArray<cmpk::MemSpace::Device, RealComm>(&shared_x_comm_prev, 2 * NUM_GRIDS_I * NUM_GRIDS_K);
    cmpk::memAllocArray<cmpk::MemSpace::Device, RealComm>(&shared_x_comm_curr, 2 * NUM_GRIDS_I * NUM_GRIDS_K);
    cmpk::memAllocArray<cmpk::MemSpace::Device, RealComm>(&shared_x_comm_next, 2 * NUM_GRIDS_I * NUM_GRIDS_K);
    ...
    cmpk::memAllocArray<cmpk::MemSpace::Host, Real    >(&shared_x_tilde_send_host, 2 * NUM_GRIDS_I * NUM_GRIDS_K);
    cmpk::memAllocArray<cmpk::MemSpace::Host, Real    >(&shared_x_tilde_recv_host, 2 * NUM_GRIDS_I * NUM_GRIDS_K);
    cmpk::memAllocArray<cmpk::MemSpace::Host, RealComm>(&shared_x_comm_prev_host , 2 * NUM_GRIDS_I * NUM_GRIDS_K);
    cmpk::memAllocArray<cmpk::MemSpace::Host, RealComm>(&shared_x_comm_curr_host , 2 * NUM_GRIDS_I * NUM_GRIDS_K);
    cmpk::memAllocArray<cmpk::MemSpace::Host, RealComm>(&shared_x_comm_next_host , 2 * NUM_GRIDS_I * NUM_GRIDS_K);
    #endif
